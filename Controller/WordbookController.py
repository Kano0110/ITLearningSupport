...
class WordbookController:
    ...
    def get_available_tags(self) -> List[str]:
        return self.book_model.get_all_tags()
    ...
    def toggle_name_view(self):
        ...
        # View側で保持しているrawデータを使うため、ここでは単にフラグ切り替え指示だけで良い
        self.view.toggle_name_display(new_state)

    def toggle_description_view(self):
        new_state = not self.view.desc_is_visible
        self.view.toggle_description_display(new_state)
